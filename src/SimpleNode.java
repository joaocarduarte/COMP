...
class SimpleNode implements Node {
	...
	private void analyzeBlock(SimpleNode block, PrintWriter writer) {
		for(int k = 0; k < block.children.length; k++)
		{
			...
			{
				analyzeFor(c, writer, (SimpleNode)block.children[k+1]);
				writer.print(analyzeLine((SimpleNode)block.children[k+1]));
				k++;
			}
	...
	private void analyzeFor(SimpleNode c, PrintWriter writer, SimpleNode after) { // For com c�digo � frente
		// TODO ver se after n�o � ciclo ou if
	...
	private void analyzeIf(SimpleNode c, PrintWriter writer, SimpleNode after) { // caso haja c�digo depois do IF
		//TODO ver se after n�o � ciclo ou if
